...
export const MCP_TOOL_MANIFEST: McpToolManifestEntry[] = [
  ...
  { name: 'kangentic_create_backlog_item', label: 'Create Backlog Item', blurb: 'stage a new item in the backlog, with an optional due date', category: 'board' },
  { name: 'kangentic_promote_backlog', label: 'Promote Backlog', blurb: 'move backlog items onto the board as tasks', category: 'board' },
  { name: 'kangentic_update_backlog_item', label: 'Update Backlog Item', blurb: 'edit a backlog item title, description, priority, labels, due date, metadata, or attachments', category: 'board' },
